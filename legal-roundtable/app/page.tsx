...
const latestArticles = [
	{
		id: 1,
		title: 'AI時代的著作權保護：從判決案例看新興科技法律挑戰',
		excerpt:
			'隨著生成式AI技術的快速發展，傳統著作權法面臨前所未有的挑戰。本文從近期相關判決出發，探討AI創作物的法律地位及其對既有法律框架的衝擊...',
		author: '王志明',
		category: '判決解析',
		date: '2024-01-15',
		readTime: '8 分鐘',
	...
	{
		id: 2,
		title: '新手律師執業初期的實務技巧與常見陷阱',
		excerpt:
			'剛踏入法律實務的新手律師往往面臨理論與實務的落差。本文整理了執業初期需要掌握的核心技能，以及應該避免的常見錯誤...',
		author: '林佳慧',
		category: '實務指南',
		date: '2024-01-12',
		readTime: '6 分鐘',
	...
	{
		id: 3,
		title: '公司治理新制度下的董事責任與風險管控',
		excerpt:
			'近年來公司治理法制的重大變革對董事會運作產生深遠影響。本文分析新制度下董事的法律責任邊界，並提供風險管控的實務建議...',
		author: '陳建國',
		category: '法學理論',
		date: '2024-01-10',
		readTime: '10 分鐘',
...
// Mock data for featured writers (adjusted for 2-3 writers)
const featuredWriters = [
	{
		...
		articles: 15,
		expertise: 'AI法律、專利訴訟',
		quote: '科技發展的腳步永遠比法律快，我們需要用智慧填補這個gap。',
	},
	{
		name: '林佳慧',
		title: '商事法專家',
